...
Route::post('/perfil/follow/{id}', [App\Http\Controllers\PublicarController::class, 'follow'])->middleware('auth')->name('perfil.follow');
...
Route::delete('/configuracoes/{id}', [App\Http\Controllers\Auth\ConfiguracoesController::class, 'destroy'])->name('configuracoes.destroy');

Route::get('/privacidade', [App\Http\Controllers\Auth\ConfiguracoesController::class, 'privacidade'])->name('privacidade');

Route::get('/edit/{id}', [App\Http\Controllers\Auth\ConfiguracoesController::class, 'edit'])->name('edit-vagas');

Route::put('vages/update/{id}', [App\Http\Controllers\Auth\ConfiguracoesController::class, 'update'])->name('update');

Route::get('/edit', [App\Http\Controllers\VagasController::class, 'edit'])->name('edit');

Route::put('/edit/{id_vaga}', [App\Http\Controllers\VagasController::class, 'update'])->name('update.vagas');

Route::delete('/vages/{id}', [App\Http\Controllers\VagasController::class, 'destroy'])->name('vages.destroy');  
...
Route::post ('/arquivos', [App\Http\Controllers\Projetocontroller::class, 'store'])->name('arquivolistado');
Route::get ('/listarquivos/{id}', [App\Http\Controllers\Projetocontroller::class, 'visualizar'])->name('arquivolistadojulio');
...
Route::get ('/notificou/{id_seg}/{id_fol}', [App\Http\Controllers\NotificacaoController::class, 'notify'])->name('notificou');
