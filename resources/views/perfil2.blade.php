...
<head>
    ...
    <script src="https://kit.fontawesome.com/ea72ae51ba.js" crossorigin="anonymous"></script>
        ...
        <body class="p-0 m-0">
         <div class="h-[220px] bg-[#A0AEEB] bg-left-top bg-auto bg-repeat-x"></div>
                            ...
                            <div class="relative  min-w-0  w-full   rounded-lg ">
                                <div class="px-6">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button id="bt-seguir" 
                                    class="rounded-[20px] w-[15em] h-[2.5em] mb-[1rem] mt-4 items-center text-center bg-purple-400 text-white font-bold hover:bg-white hover:text-[#3C1564] hover:border hover:border-[#3C1564]">
