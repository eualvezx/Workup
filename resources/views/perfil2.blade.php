                            ...
                            <div class="relative  min-w-0  w-full   rounded-lg ">
                                <div class="px-6">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button id="bt-seguir" 
                                    class="rounded-[20px] w-[15em] h-[2.5em] mb-[1rem] mt-4 items-center text-center bg-[#4B0082] text-white font-bold hover:bg-[#A0AEEB] hover:text-[#4B0082] hover:border hover:border-[#3C1564]">
