...
@include('navbar')
        ...
        <div class=" ">
            ...
            <div id="aba-contatos" class="grid grid-rows-2 grid-flow-col w-80 mr-8 rounded-lg">
                ...
                <div id="lista-recomendados" class=" shadow -mt-8 grid grid-rows-4 bg-purple-400 rounded-lg text-center h-64 px-2 py-2 ">
                    <p>Ademilson</p>
                    <hr>
                    <p>Ademilson</p>
                    <hr>
                ...
                <div id="lista-contatos" class=" shadow grid grid-rows-4 bg-purple-400 -mt-20  rounded-lg text-center px-2 py-2">
