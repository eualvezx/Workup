...
<nav class="bg-white p-0 shadow-[0_0_4px_3px_rgba(0,0,0,0.2)] ">
  ...
  <div class="container mx-auto flex justify-between py-1 items-center">
    ...
    <div>
      <a href="/home"><img src="{{\Illuminate\Support\Facades\Storage::disk('public')->url('imagem/logoworkup.png')}}" class="w-14 h-14 mr-2 object-cover " name="logo" class="w-12 h-12 mr-2 rounded-full"></a>
    </div>
