...
<nav class="bg-white p-0 shadow-[0_0_4px_3px_rgba(0,0,0,0.2)] ">
  ...
  <div class="container mx-auto flex justify-between py-1 items-center">
    ...
    <div>
      <a href="/home"><img src="{{\Illuminate\Support\Facades\Storage::disk('public')->url('imagem/logoworkup.png')}}" class="w-14 h-14 mr-2 object-cover rounded-full" name="logo" class="w-12 h-12 mr-2 rounded-full"></a>
    </div>
    ...
    <div class="relative flex items-center">
      ...
      <ul style="z-index: 2;" class="pl-0 hidden absolute bg-white text-black shadow-[0_0_4px_3px_rgba(0,0,0,0.2)] mt-[15em]   w-52 rounded-xl text-center">
        <li >
          <a href="/perfil2" class="no-underline block px-4 py-2 text-[#3C1564] hover:bg-[#DFE5F2] hover:rounded-t-xl font-bold ">Ver perfil</a>
        </li>
        
        <li>
          <a href="/configuracoes" class="no-underline text-black block px-4 py-2 hover:bg-[#DFE5F2] ">Configurações</a>
        </li>
        <li>
          <a href="{{ route('logout') }}" class="no-underline text-black block px-4 py-2 hover:bg-[#DFE5F2] hover:rounded-b-xl" onclick="event.preventDefault();
