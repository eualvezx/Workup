...
<nav class="bg-white p-0 shadow-[0_0_5px_5px_rgba(0,0,0,0.2)] h-[5em] items-center">
    <div class="container mx-auto flex justify-between items-center">
      ...
      <ul class="flex space-x-14">
        ...
        <li>
          <a href="/notificacao" class="text-black hover:text-[#3C1564]"><i class="fa-sharp fa-solid fa-bell fa-xl"></i></a>
        </li>
      ...
      <div class="relative flex items-center">
        ...
        <a href="/perfil2"><img src="
          {{\Illuminate\Support\Facades\Storage::disk('public')->url(Auth::user()->imagem)}}" name="logo" class="w-14 h-14 mr-2 object-cover rounded-full"></a>
