...
@section('content')
    ...
    <div class="flex flex-row text-5xl ml-24 mb-24">
        Work Up
    </div>


    <div class="flex flex-row justify-content-center gap-24 "> 

       <!-- CARD LOGIN -->
        <div class="container border max-w-sm m-0">
            <div class="row  ">
        ...
        <div class=" border h-full">
            <img class="oval" src="https://play-lh.googleusercontent.com/VH2wj52NFwCVzlzgrhT9k69ZOPO6oyUM-gS5QNWH4m0UqzIMp3UY5W2GwkUVU9HYCg">
        </div>
    ...
    <div class="">
        <hr class="mx-24 mt-72 mb-8">
        <center>
        <footer > WorkUp - 2023 </footer>
        </center>
    </div>
