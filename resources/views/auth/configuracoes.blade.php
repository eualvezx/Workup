...
<button href="/privacidade"  class="w-[12em] h-[2em] mb-[1rem] items-center text-center font-medium text-[20px]">
    ...
    <div class="container mx-auto float-right">
        <div class="row justify-content-center">
            ...
            <div class="grid grid-rows-5  grid-flow-col gap-4 border shadow-md rounded-lg p-2 w-96 mt-12 justify-center">

            <div class="">
                                <input type="file" id="foto_pub" name="foto_pub" value="{{ old('foto_pub') }}" required
                                autocomplete="foto_pub" hidden onchange="previewImagem()" />
                            <img class="flex w-[360px] h-[200px] rounded-[20px]" id="view"> </img>
                            <span class="flex">
                                <label for="foto_pub">
