...
<body>
    ...
    <div class="w-full max-w-sm p-4 bg-white border-gray-700 rounded-lg shadow sm:p-6 md:p-8  ">
        ...
        <div class="container mx-auto py-8">
            ...
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="formacoes2">Formações:</label>
                <div class="relative">
            ...
            <div>
                <button type="submit"
                 class="text-purple font-medium rounded-full text-sm px-10 py-1.5 text-center">
                Finalizar
                </button>
                </div>
        </form>
