...
<?php
 ...
 echo"<div class='grid lg:grid-cols-3  mx-5 my-5 absolute gap-10 '>";
  foreach ($s as $k) {
    if ($k !="." && $k !=".." ) {
        $arquivo = $k;
        echo " 
        <button class='h-[15em] w-[15em] rounded-[15px] shadow-lg bg-white text-center hover:bg-white hover:text-[#3C1564] hover:border hover:border-[#3C1564]'>
    ...
    <a href='/arquivos?subject=$k' class='p-[8px] text-[18px] font-semibold'>$k</a> 
    </button>";
    }
  }
echo "</div>";
