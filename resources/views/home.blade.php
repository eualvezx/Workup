...
<style>
    ...
    <div class="container">
        <div class="cols-2  justify-content-center float-left w-[800px]">
            ...
            <div class="col-md">
                ...
                <img  src="{{\Illuminate\Support\Facades\Storage::disk('public')->url(Auth::user()->imagem)}}" name="logo" class="w-14  h-14 rounded-full float-left object-cover">
                    ...
                    <div>
                     ...
                     <a href="a" data-toggle="modal" data-target="#ModalCreate1" style="color: #000000" class="no-underline">
            ...
            <span class="text-gray-600 font-medium">Upar arquivo</span>
            </label>
                                ...
                                <button onclick="myFunction()" class="dropbtn"></button> 
                                    ...
                                    <a>
                                            <form action="/home/{{ $pub->id }}" method="POST">
                                                ...
                                                <button type="submit" class="fs-6 fw-semibold"><i class="fa-solid fa-xmark" style="color: #000000;"></i> Excluir</button>
                                            </form>
                    </a>
                                  </div>
        ...
        <form action="{{route('homenow')}}" method="GET">
                ...
                <div class="float-right w-full  bg-white shadow-md p-3 rounded"  id="minhaDiv"  >
                        ...
                        <div class="float-left">
                            ...
                            <br>
                        <a class="no-underline text-black float-left p-0 m-0 text-[16px]" href="{{route('nomehome', ['id' => $useraa->id])}}">
                            <img src="{{\Illuminate\Support\Facades\Storage::disk('public')->url($useraa->imagem)}}" name="logo" class="w-14 h-14 rounded-full float-left object-cover">
                            <p> {{$useraa->name}}</p></a>
