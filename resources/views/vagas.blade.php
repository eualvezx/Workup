...
<body class="bg-white">
        ...
        <div class="float-left w-[24rem] text-center space-y-5">


        <br>
        @if(Auth::user()->typecont > 1)
        <a href="a" class="no-underline text-white" data-toggle="modal" data-target="#ModalCreateVaga">
        <button id="vagabutton" class="w-52 bg-[#3C1564] text-white rounded-full px-4 py-2 hover:bg-purple-600">
            ...
            <div class=" bg-gray-100 ">
                <div class="md:flex">
                    ...
                    <div class="ml-2 w-full  space-x-2 text-left">
                        ...
                        <div class="uppercase tracking-wide  text-lg text-indigo-500 font-semibold">{{ $vaga -> titulo }}</div>
                            <div class="">
        ...
        {{ $vaga1 -> carga_hr }}
            ...
            <a href="/chatify/{{$vaga->relVagas->id}}">
                ...
                <button  type="submit" id="" class="rounded-full  w-[12em] h-[2em] mb-[1rem]  items-center text-center bg-[#3C1564] text-white font-medium text-[15px]"> <i class="fa-sharp fa-solid fa-clipboard-list" style="color: #ffffff;"></i>
                 Negociar</button>
