...
<body>
  <nav class="navbar sticky-top navbar-expand-lg rounded navbar-light" style="background-color: #3C1564;" id="nav">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
            ...
            <div class="form-group" id="attachment">
              <div class="controls text-center">
                <div class="input-group w-100">
                  <a class="btn text-light w-100" style="background-color: #3C1564;" id="upload-button">{{ trans('laravel-filemanager::lfm.message-choose') }}</a>
                </div>
              </div>
            </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-light w-100" style="border-color: #3C1564;" data-dismiss="modal">{{ trans('laravel-filemanager::lfm.btn-close') }}</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="notify" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-light w-100" style="border-color: #3C1564;" data-dismiss="modal">{{ trans('laravel-filemanager::lfm.btn-close') }}</button>
          <button type="button" class="btn text-light w-100" style="background-color: #3C1564;" data-dismiss="modal">{{ trans('laravel-filemanager::lfm.btn-confirm') }}</button>
        </div>
      </div>
    </div>
  </div>
