...
<div class="messenger">
    ...
    <div class="messenger-listView {{ !!$id ? 'conversation-active' : '' }}">
        ...
        <div class="m-header">
            <nav>
                <a href="#"><a href="\home"><i class="fas fa-home"></i></a> <span class="messenger-headTitle">MENSAGENS</span> </a>
                {{-- header buttons --}}
        ...
        <div class="m-body contacts-container">
           ...
           <div class="messenger-tab search-tab app-scroll" data-view="search">
                ...
                <div class="search-records">
                    <p class="message-hint center-el"><span>Escreva para pesquisar...</span></p>
                </div>
             </div>
        </div>
    </div>
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-header m-header-messaging">
            <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                ...
                <div class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                    ...
                    <a href="#" class="user-name">Work Up </a>
                </div>
                {{-- header buttons --}}
                <nav class="m-header-right">
        ...
        <div class="m-body messages-container app-scroll">
            <div class="messages">
                <p class="message-hint center-el"><span>Por favor selecione um chat para começar uma mensagem</span></p>
            </div>
            {{-- Typing indicator --}}
