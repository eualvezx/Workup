                        ...
                        <div class="w-full px-4 mx-auto">
                            <div class="relative  min-w-0  w-full   rounded-lg ">
                                ...
                                <form method="POST" action="{{ route('perfil.unfollow', $ouser->id) }}">
                                    ...
                                    <i class="fa-sharp fa-solid fa-plus"></i> Deixar de seguir
                                    </button>
</form>
                                @else
                                <form method="POST" action="{{ route('perfil.follow', $ouser->id) }}">
                                    ...
                                    <i class="fa-sharp fa-solid fa-plus"></i>Seguir 
                                    </button>
                                ...
                                <a href="/chatify/{{$ouser->id}}"><button class="rounded-[20px] p-1 w-[15em] h-[2.5em] mb-[1rem]  items-center text-center bg-indigo-600  font-bold
