...
<div class="flex bg-white shadow-lg rounded-lg  md:mx-auto  max-w-md md:max-w-2xl "><!--horizantil margin is just for display-->
   <div class="flex items-start px-4 py-6">
      <img class="w-12 h-12 rounded-full object-cover mr-4 shadow" src="https://us-tuna-sounds-images.voicemod.net/b642faaa-9e71-403f-8400-eb5577fc2f88-1681535373710.jpg">
      <div class="">
         ...
         <div class="mt-4 flex items-center">
            ...
            <img src="/img/{{$pub->imagem}}" alt="{{$pub->id}}" class="w-40"> 
